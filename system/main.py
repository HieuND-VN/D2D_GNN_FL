...
# def run(args, env, benchmark_10):
    ...
    for i in range(args.prev, args.times):
        ...
        server.illustrate_bm(loss_tr10_te10, loss_tr50_te10, loss_tr100_te10, optimization10, case = 1)
        server.illustrate_bm(loss_tr10_te50, loss_tr50_te50, loss_tr100_te50, optimization50, case = 2)
        server.illustrate_bm(loss_tr10_te100, loss_tr50_te100, loss_tr100_te100, optimization100, case = 3)
