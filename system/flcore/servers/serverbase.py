...
class Server(object):
    ...
    def illustrate(self, env):
        ...
        plt.plot(self.test_loss_client_save, label='Testing summarize K')
        plt.plot(self.test_loss_10_save, label='Testing K = 10')
        plt.plot(self.test_loss_50_save, label='Testing K = 50')
        plt.plot(self.test_loss_100_save, label='Testing K = 100')
